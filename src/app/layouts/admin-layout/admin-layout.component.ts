...
export class AdminLayoutComponent implements OnInit, AfterViewInit {
  ...
  OnClick: boolean;
  name: any;
  constructor( public location: Location, private router: Router, private Service: ServicesService) {
    console.log('hihi admin layout comp');
  ...
  ngOnInit() {
    ...
    console.log('hihi admin layout comp 2');
    ...
    console.log('hihi admin layout comp 3');
...
// tslint:disable-next-line:variable-name
  ...
  getChartCompID(e: any) {
    ...
    this.Service.sendIdComponent(this.IdChartComponent);
