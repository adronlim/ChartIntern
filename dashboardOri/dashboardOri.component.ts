...
@Component({
  ...
  templateUrl: './dashboardOri.component.html',
  styleUrls: ['./dashboardOri.component.css']
})
export class DashboardOriComponent implements OnInit, AfterViewInit, OnChanges, OnDestroy {
  @Input() onClick: any;
  _idComponentDB: any;
  id_Component_DB: any;
